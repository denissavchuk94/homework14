...
function ageClassification(n) {
  var age = 0 
  n < 0 ? age = null :
    n <= 24 ? age = 'детский возраст' :
      n <= 44 ? age = 'молодой возраст' :
        n <= 65 ? age = 'средний возраст' :
          n <= 75 ? age = 'пожилой возраст' :
            n <= 90 ? age = 'старческий возраст' :
              n <= 122 ? age = 'долгожители' :
       age = null;
  return age;
...
console.log(mainFunc(3, 3, cbPow)); // 32
